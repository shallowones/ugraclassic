...
<html lang="ru">
	<head>
		<title><?$APPLICATION->ShowTitle(false);?> - Камерный духовой оркестр «Сибирь барс»</title>		
	...
	<body>
		...
		<div id="header">
			<div class="wrapper">
				...
				<a href="/collective/sibir-brass/" title="Главная страница Камерного духового оркестра «Сибирь барс»">
					<div class="logo"></div>
				</a>
	...
	array(
		...
		"NUM_CATEGORIES" => "1",
		"ORDER" => "date",
		"PAGE" => "#SITE_DIR#collective/sibir-brass/search/",
	...
	array(
		...
		<?if ($APPLICATION->GetCurPage() != "/collective/sibir-brass/index.php"):?>
