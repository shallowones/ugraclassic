...
<html lang="ru">
	<head>
		<title><?$APPLICATION->ShowTitle(false);?> - Ансамбль русской песни «Млада»</title>		
	...
	<body>
		...
		<div id="header">
			<div class="wrapper">
				...
				<a href="/collective/mlada/" title="Главная страница Ансамбля русской песни «Млада»">
					<div class="logo"></div>
				</a>
	...
	array(
		...
		"NUM_CATEGORIES" => "1",
		"ORDER" => "date",
		"PAGE" => "#SITE_DIR#collective/mlada/search/",
