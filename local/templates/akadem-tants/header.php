...
<html lang="ru">
	<head>
		<title><?$APPLICATION->ShowTitle(false);?> - Академия танца</title>		
	...
	<body>
		...
		<div id="header">
			<div class="wrapper">
				...
				<a href="/collective/akadem-tants/" title="Главная страница Академии танца">
					<div class="logo">Академия танца</div>
				</a>
	...
	array(
		...
		"NUM_CATEGORIES" => "1",
		"ORDER" => "date",
		"PAGE" => "#SITE_DIR#collective/akadem-tants/search/",
	...
	array(
		...
		<?if ($APPLICATION->GetCurPage() != "/collective/akadem-tants/index.php"):?>
