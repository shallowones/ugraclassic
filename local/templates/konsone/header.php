...
<html lang="ru">
	<head>
		<title><?$APPLICATION->ShowTitle(false);?> - Главная страница Ансамбля камерной музыки «Консоне»</title>		
	...
	<body>
		...
		<div id="header">
			<div class="wrapper">
				...
				<a href="/collective/konsone/" title="Главная страница Ансамбля камерной музыки «Консоне»">
					<div class="logo"></div>
				</a>
	...
	array(
		...
		"NUM_CATEGORIES" => "1",
		"ORDER" => "date",
		"PAGE" => "#SITE_DIR#collective/konsone/search/",
	...
	array(
		...
		<?if ($APPLICATION->GetCurPage() != "/collective/konsone/index.php"):?>
