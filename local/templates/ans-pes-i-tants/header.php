...
<html lang="ru">
	<head>
		<title><?$APPLICATION->ShowTitle(false);?> - Ансамбль песни и танца</title>		
	...
	<body>
		...
		<div id="header">
			<div class="wrapper">
				...
				<a href="/collective/ans-pes-i-tants/" title="Главная страница Ансамбля песни и танца">
					<div class="logo">Ансамбль песни и танца</div>
				</a>
	...
	array(
		...
		"NUM_CATEGORIES" => "1",
		"ORDER" => "date",
		"PAGE" => "#SITE_DIR#collective/ans-pes-i-tants/search/",
	...
	array(
		...
		<?if ($APPLICATION->GetCurPage() != "/collective/ans-pes-i-tants/index.php"):?>
