...
<html lang="ru">
	<head>
		<title><?$APPLICATION->ShowTitle(false);?> - Симфонический оркестр</title>		
	...
	<body>
		...
		<div id="header">
			<div class="wrapper">
				...
				<a href="/collective/dukh-or-yugry/" title="Главная страница Симфонического Оркестра">
					<div class="logo">Симфонический оркестр</div>
				</a>
						...
						<div class="search-head">
							<?$APPLICATION->IncludeComponent(
								...
								array(
									...
									"NUM_CATEGORIES" => "1",
									"ORDER" => "date",
									"PAGE" => "#SITE_DIR#collective/dukh-or-yugry/search/",
	...
	array(
		...
		<?if ($APPLICATION->GetCurPage() != "/collective/dukh-or-yugry/index.php"):?>
