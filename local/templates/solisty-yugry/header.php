...
<html lang="ru">
	<head>
		<title><?$APPLICATION->ShowTitle(false);?> - Вокальный ансамбль «Солисты Югры»</title>		
	...
	<body>
		...
		<div id="header">
			<div class="wrapper">
				...
				<a href="/collective/solisty-yugry/" title="Главная страница Вокального ансамбля «Солисты Югры»">
					<div class="logo"></div>
				</a>
	...
	array(
		...
		"NUM_CATEGORIES" => "1",
		"ORDER" => "date",
		"PAGE" => "#SITE_DIR#collective/solisty-yugry/search/",
	...
	array(
		...
		<?if ($APPLICATION->GetCurPage() != "/collective/solisty-yugry/index.php"):?>
