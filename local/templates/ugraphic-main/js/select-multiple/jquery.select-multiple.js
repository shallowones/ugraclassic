  ...
  * ====================== */
  ...
  SelectMultiple.prototype = {
    ...
    'generateLisFromOption' : function(option, index, $container){
      ...
      var selectableLi = $('<li '+attributes+'><span>'+(that.options.allowHTML === true ? $option.text() : that.escapeHTML($option.text()))+'</span><span class="gray"></span><span class="pull-right ms-elem-selected"></span></li>'),
