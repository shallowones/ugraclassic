...
?>
    ...
    <form method="get" action="#" enctype="multipart/form-data" class="feedback-form">
        ...
        <div class="s-line">
            ...
            <textarea id="message" name="message">Очень классный сайт, особенно дизайн Данный сервис предназначен для обратной связи с КТЦ«Югра-Классик».Воспользуйтесь формой, чтобы задать интересующий Вас вопрос, отправить комментарии, замечания или предложения чтобы задать интересующий Вас вопрос. фывфывфывфывфывфывфывфыв</textarea>
        </div>
        <div class="t-line">
            <div class="cap-block">
